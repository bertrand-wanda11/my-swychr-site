...
<div class="Girl">
 ...
 <nav class="numeroAir">
  ...
  <div class="stavoAir-con"> 
    <li class="stavoAir"><a href="https://urlgeni.us/swychr">Open Web App<img src="@/assets/images/ror.png" alt="App Store"  width="13px"/></a></li>
  </div>
</nav>     
...
.benefit-card:hover {
  ...
  border-color: rgba(129, 63, 214, 0.5); 
